...
// http_conn::HTTP_CODE http_conn::parse_http_request(){

//     http_conn::LINE_STATUS line_state = http_conn::LINE_OK;
//     http_conn::HTTP_CODE ret_code = http_conn::NO_REQUEST;

//     char *text = 0;
//     while((( m_check_state == http_conn::CHECK_STATE_CONTENT) && (line_state == http_conn::LINE_OK))
//             || ((line_state = parse_line())== http_conn::LINE_OK)){

//             text = get_line();

//             m_start_line = m_checked_idx;
//             printf("got one http_line : %s\n", text);
...
// http_conn::HTTP_CODE http_conn::parse_http_content(char* text){
...
// 网站的根目录
const char *doc_root = "/home/user/Linux/webserver/webserver/resources";
